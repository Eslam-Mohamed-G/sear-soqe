                    ...
                    <div className="flex flex-row flex-wrap justify-start gap-4 mt-2">
                        {listings.map((car) => (
                            <div onClick={() => { navigate(`/specificOffer/${car.id}`) }} key={car.id} className="flex flex-col gap-4 w-fit rounded-xl p-4 customShadow cursor-pointer group relative">
                                <div className="absolute top-4 end-3 z-50 rounded-lg px-1.5 py-0.5 flex flex-row items-center justify-center gap-4">
                                    {/* delete */}
                                    <button onClick={(e) => {e.stopPropagation(); deleteListing(car.id); }}>
                                    ...
                                    <button>
                                        <svg width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clipPath="url(#clip0_13_1402)">
                                                <path d="M13.28 6.4268L13.898 5.8088C14.3897 5.31717 14.6658 4.65039 14.6658 3.95513C14.6658 3.25987 14.3897 2.59309 13.898 2.10146C13.4064 1.60984 12.7396 1.33365 12.0444 1.33365C11.3491 1.33365 10.6823 1.60984 10.1907 2.10146L9.5727 2.71946L3.89136 8.39946C3.50669 8.7848 3.31403 8.97746 3.1487 9.18946C2.95362 9.43978 2.7862 9.71047 2.64936 9.9968C2.53403 10.2395 2.44803 10.4981 2.27603 11.0141L1.5467 13.2015M13.28 6.4268C13.28 6.4268 11.9674 6.34946 10.8087 5.1908C9.65003 4.0328 9.57336 2.71946 9.57336 2.71946M13.28 6.4268L7.59936 12.1068C7.21469 12.4915 7.02203 12.6841 6.81003 12.8495C6.55971 13.0445 6.28903 13.212 6.0027 13.3488C5.76003 13.4641 5.50203 13.5501 4.98536 13.7221L2.79803 14.4515M2.79803 14.4515L2.26336 14.6301C2.13873 14.6719 2.00491 14.6781 1.87695 14.648C1.74899 14.6179 1.63196 14.5528 1.53901 14.4598C1.44606 14.3669 1.38088 14.2498 1.35079 14.1219C1.3207 13.9939 1.3269 13.8601 1.36869 13.7355L1.54736 13.2008L2.79803 14.4515Z" stroke="#4044C9" />
                                            </g>
                                            <defs>
