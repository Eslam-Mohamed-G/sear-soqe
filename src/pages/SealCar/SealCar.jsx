        ...
        <div className="w-full mx-auto bg-white p-6 md:p-8 rounded-xl customShadow mt-3 md:mt-5">
            {token ?
                (!successMessage ?
                    ...
                    :
                    <div className="absolute h-dvh top-0 start-0 end-0 bg-backgroundLinear flex flex-col items-center justify-center border">
                        {/* close buttom */}
                        <button onClick={()=>setSuccessMessage(false)} className="cursor-pointer absolute start-4 md:start-8 top-28">
                        ...
                        {/* images */}
                        <div className="w-80 h-60 relative flex items-center justify-center">
                            <img src="/successMessage.png" alt="successMessage" className="w-full h-full object-contain" />
                            <div className="w-28 h-28 absolute bottom-11 end-13">
                                <img src="/party-popper.png" alt="party-popper" className="w-full object-contain" />
                            </div>
                        </div>

                        {/* text */}
                        <div className="text-white text-center px-8">
                            <h1 className="text-2xl mb-4">تهانينا !</h1>
                            <p>تم نشر إعلانك سيبدا فى الظهور فى نتائج البحث خلال بعض دقائق</p>

                            <button className="bg-white rounded-lg text-[#4044C9] text-lg px-8 py-4 mt-4">
                                <Link to="/profile">إعلاناتي</Link>
                            </button>
                        </div>
                    </div>
                )
